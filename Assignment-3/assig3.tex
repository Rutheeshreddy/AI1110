...
\begin{enumerate}
\item Total number of families is sum of values in all cells,
which is = 2400
...
&= 0.0104
\end{align}
\item For this case, the number of families is given by the sum of columns 0 and 1 in Table \ref{table:table1}.  Hence, 
\begin{align}
\pr{X <  2}
 &= \frac{2062}{2400}
\\
