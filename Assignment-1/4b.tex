...
\item If two lines are perpendicular, then dot product of their normal vector transposes is 0.
\newline
...
\item The equation of a line  is given by 
 ...
 \end{align}
  with $\myvec{3\\-5}$ as normal vector transpose.
 \newline \newline
...
\end{align}  
   with $\myvec{4\\a}$ as normal vector transpose.
\newline \newline
By result in 1, 
 \begin{align}
