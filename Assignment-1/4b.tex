...
\item If two lines with normals $\vec{n}_1,\vec{n}_2$ are perpendicular, then
\begin{align}
  \vec{n}^{\top}_1\vec{n}_2 = \vec{n}^{\top}_2\vec{n}_1 = 0 \label{eq:eq1}
\end{align}
...
\item The equation of a line  is given by 
 ...
 \end{align}
  with $\vec{n}_1 = \myvec{3\\-5}$ as normal vector.
...
\end{align}  
   with $\vec{n}_2 = \myvec{4\\a}$ as normal vector.

By result  \eqref{eq:eq1}, 
 \begin{align}
 \vec{n}^{\top}_1\vec{n}_2 &= 0 \\
 \myvec{3&-5}\myvec{4\\a} &= 0\\
    12 - 5a &= 0 \\
   \therefore  a &= \frac{12}{5}
\end{align}  
%These newlines are included to place figure in a better manner 
  \\\\\\\\\\\\
\section*{\textbf{Plot}}   
 \begin{figure}[h!]  
