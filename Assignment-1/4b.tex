...
The equation of a line  is given by  
 ...
 Vector form of 3x - 5y =7 is \\ $\myvec{3\\-5}\myvec{x\\y} = 7$,\, with $\myvec{3\\-5}$ as normal vector.
 \newline \newline
 
 
 Vector form of 4x+ay+9=0 is  \\ $\myvec{4\\a}\myvec{x\\y} =-9$,\, with $\myvec{4\\a}$ as normal vector.
\newline 
